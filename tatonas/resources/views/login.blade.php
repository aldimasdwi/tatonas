                ...
                <h1 class="text-gray-800 font-bold text-2xl mb-1">Hello Again!</h1>
                        ...
                        <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                            ...
                            <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                                ...
                                <a href="/register" class="text-sm ml-2 t hover:text-blue-500 cursor-pointer">Register di sini</a> kemabali ke halaman depan <a href="/" class="text-sm ml-2 t hover:text-blue-500 cursor-pointer">Back di sini</a>
